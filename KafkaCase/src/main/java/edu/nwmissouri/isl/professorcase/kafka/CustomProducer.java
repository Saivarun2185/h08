...
//    int pageno = 1;
   ...
   String[] datasample = {"Hello","I","am","Saivarun","Illendula","MSACS","NWMSU","Maryville","Missouri","Bearcat","Fall"};
    data = Arrays.asList(datasample);
    ...
    //   System.out.println("Total: " + statuses.size());
      ...
      for (String d : data) {
        // String s = "@" + status.getUser().getScreenName() + ":" + status.getText();
         System.out.println("Posting " + i++ +". See Consumer for details.");
         ProducerRecord<String, String> rec = new ProducerRecord<String, String>(topicName, d);
